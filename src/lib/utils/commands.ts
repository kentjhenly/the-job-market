...
export const CANDIDATE_FKEYS: [string, CommandDef][] = [
  ["F1", CANDIDATE_COMMANDS[6]],
  ["F2", CANDIDATE_COMMANDS[0]],
  ["F3", CANDIDATE_COMMANDS[1]],
  ["F4", CANDIDATE_COMMANDS[2]],
  ["F6", CANDIDATE_COMMANDS[3]],
  ["F7", CANDIDATE_COMMANDS[4]],
  ["F9", CANDIDATE_COMMANDS[5]],
];
...
export const EMPLOYER_FKEYS: [string, CommandDef][] = [
  ["F1", EMPLOYER_COMMANDS[5]],
  ["F2", EMPLOYER_COMMANDS[0]],
...
export const PUBLIC_FKEYS: [string, CommandDef][] = [
  ["F1", PUBLIC_COMMANDS[2]],
  ["F2", PUBLIC_COMMANDS[0]],
  ["F9", PUBLIC_COMMANDS[1]],
];
