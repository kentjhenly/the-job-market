  ...
  return (
    <div className="view-enter scroll-main space-y-6">
      ...
      <div className="flex items-end justify-between gap-3">
        ...
        {employer?.verified && <Badge variant="gold">VERIFIED RECRUITER</Badge>}
      </div>

      {/* ROW 1 — asymmetric hero: RECRUITER REPUTATION + HIRING SUMMARY */}
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-[minmax(0,1.65fr)_minmax(280px,1fr)]">
        ...
        <div className="panel panel-accent flex flex-col">
          <div className="panel-head">
            <span className="panel-title">RECRUITER REPUTATION</span>
        ...
        <div className="panel flex flex-col" style={{ borderTopWidth: 2 }}>
          ...
          <div className="flex flex-1 flex-col p-4">
            ...
            >
              ...
              {!subscriptionActive && (
                <Link href="/recruiter/feed" className="link-up mono mt-2 block" style={{ fontSize: 11 }}>UPGRADE →</Link>
              )}
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <div className="panel flex flex-col">
          <div className="panel-head">
            ...
            {postingList.length > 0 && (
              <Link href="/recruiter/feed" className="link-up mono ml-auto" style={{ fontSize: 11 }}>
                FEED →
              </Link>
            )}
          </div>
          {topMatches.length === 0 ? (
            <div className="flex flex-1 flex-col items-center justify-center gap-2 py-10">
              ...
              <Link href="/recruiter/postings" className="link-up mono mt-1" style={{ fontSize: 11 }}>
                CREATE OPENING →
              </Link>
            </div>
          ) : (
            <>
              ...
              {topMatches.map((m, idx) => (
                <Link
                  key={m.candidate_id}
                  href={`/recruiter/postings/${m.posting_id}`}
        ...
        <div className="panel">
          <div className="panel-head">
            ...
            <Link href="/recruiter/matches" className="link-up mono ml-auto" style={{ fontSize: 11 }}>VIEW ALL</Link>
          </div>
